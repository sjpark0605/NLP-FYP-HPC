...
python3 /cluster/project2/COMP0029_17022125/NLP-FYP-HPC/directional-label/directional_label_flow_graph_training_loop.py  --t "$target" --us "$undersample" --epochs "$epochs"
hostname
date
/home/sejipark/test